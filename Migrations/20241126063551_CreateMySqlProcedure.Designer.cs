...
namespace iMARSARLIMS.Migrations
{
    ...
    [Migration("20241126063551_CreateMySqlProcedure")]
    partial class CreateMySqlProcedure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iMARSARLIMS.Model.Master.centreCheckList", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("centreCheckList");
                });

            modelBuilder.Entity("iMARSARLIMS.Model.Master.centreCheckListMapping", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int?>("centreMasterid")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("centreMasterid");

                    b.ToTable("centreCheckListMapping");
                });
            ...
            modelBuilder.Entity("iMARSARLIMS.Model.Master.centreCheckListMapping", b =>
                {
                    b.HasOne("iMARSARLIMS.Model.Master.centreMaster", null)
                        .WithMany("addCentreCheckListMapping")
                        .HasForeignKey("centreMasterid");
                });
            ...
            modelBuilder.Entity("iMARSARLIMS.Model.Master.centreMaster", b =>
                {
                    b.Navigation("addCentreCheckListMapping");
                });
